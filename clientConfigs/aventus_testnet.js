var appConfig = {
  ...
  BRIDGE_CONTRACT_ADDRESS: '0x83359ecb73e869174b09221f4460b68fd8b0a42f',
  BRAND_COLOR: '#5100FF',
  ...
  EXPLORER_TX_URL: 'https://explorer.testnet.aventus.io/extrinsic/',
  ARCHIVE_EXPLORER_URL: 'https://archive-explorer.testnet.aventus.io/graphql',
  GATEWAY: 'https://gateway.testnet.aventus.io/',
  ...
  SUPPORTED_TOKENS: {
    AVT: { name: 'AVT', address: '0x608156959e3a2192a870b4bac660200afb4c649f' },
    TOKEN20: {
      name: 'TOKEN20',
  ...
  INVALID_RECIPIENT_ADDRESSES: ['0x83359ecb73e869174b09221f4460b68fd8b0a42f']
}
