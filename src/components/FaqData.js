...
const FAQ = [
	...
	},
	{
		...
		answer: "We've prepared a video that will walk you through using this as a programmer.",
	...
	},
	{
		...
		answer: " Nova Wallet has an embedded browser. Paste the url for this dapp into that browser and carry on with your operations.",
	},
	{
		question: "How to Claim within the Nova wallet",
		answer: "The Nova Wallet supports both Substrate and EVM based wallets. Ensure you are using the correct wallet (address) options within Nova wallet when switching to the Claim operation.",
	},
	{
	...
	},
	{
		...
		answer: "This dapp requires an AWT token to authenticate the user for every operation.",
	},
	{
		question:
			"Why do I need to sign multiple times to submit a transaction?",
		answer: "This Dapp interacts with the chain via the Gateway and each user is authenticated on the Gateway using their unique time-limited Aventus Web Token (AWT). A new token must be generated if the existing token has expired or non-existent.",
	},
	{
	...
	},
	{
		...
		answer: "FREE balance only applies to your main token balance. This is the portion of your balance that is not locked in any way, for example, locked in staking. You can only lower what is in your FREE balance. To lower your locked tokens, you would need to unlock it and withdraw it to your FREE balance.",
	},
	{
	...
	{
		question:
			"Not sure what happened to my transaction, how can I query it?",
		answer: "Depending on what stage your transaction failed or got stuck at, you will have a different set of data returned to you. For example, you will have your UUID after the transaction has been submitted, and if the transaction has been processed, you will have the transaction hash and a link to the transaction on the block explorer.",
	},
];
