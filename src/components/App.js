...
function App() {
  ...
  const TEXT_COLOR = NETWORK_CONFIG.BRAND_TEXT_COLOR || '#ffffff'
  ...
  const ARCHIVE_EXPLORER_URL = NETWORK_CONFIG.ARCHIVE_EXPLORER_URL
  ...
  const NATIVE_CONTRACT_ADDRESS = '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE'
    ...
    <div>
      <stateContext.Provider
        value={{
          ...
          PM_Token: 'Prediction Market Token'
        }}
      >
        <Routes>
